...
figma.ui.onmessage = function (msg) {
    ...
    if (msg.type === 'create-color') {
        ...
        var selectedElements = figma.currentPage.selection.length;
        ...
        if (node.type === 'RECTANGLE') {
            ...
            var color = material_color_utilities_1.Hct.from(Number(msg.huevalue), Number(msg.chromavalue), Number(msg.tonevalue));
            var hex = (0, material_color_utilities_1.hexFromArgb)(color.toInt());
